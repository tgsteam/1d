  ...
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">资料查询系统后台</a>
      </div><!-- /.navbar-header -->
      <div id="navbar" class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-pushpin"></span> 资料管理<b class="caret"></b></a>
            <ul class="dropdown-menu">
              <li><a href="./add.php">添加资料</a><li>
			  <li class="active"><a href="./list.php">资料列表</a></li>
			  <li><a href="./search.php">搜索资料</a><li>
            </ul>
          </li>
		  <li>
...
if(isset($_GET['qq'])) {
	...
	$con='QQ '.$_GET['qq'].' 共有 <b>'.$gls.'</b> 个资料用户';
}else{
	$gls=$DB->count("SELECT count(*) from black_list WHERE 1");
	$sql=" 1";
	$con='资料后台共有 <b>'.$gls.'</b> 个资料用户';
}
...
?>
      <div class="table-responsive">
        <table class="table table-striped">
          <thead><tr><th>ID</th><th>ＱＱ</th><th>添加时间</th><th>资料等级</th><th>操作</th></tr></thead>
          <tbody>
<?php
$rs=$DB->query("SELECT * FROM black_list WHERE{$sql} order by id desc limit $pageu,$pagesize");
while($res = $DB->fetch($rs))
{
echo '<tr><td>'.$res['id'].'</td><td>'.$res['qq'].'</td><td>'.$res['date'].'</td><td>'.$res['level'].'级</td><td><a href="./edit.php?my=update&id='.$res['id'].'" class="btn btn-xs btn-info">修改</a> <a href="./edit.php?my=del&id='.$res['id'].'" class="btn btn-xs btn-danger" onclick="return confirm(\'你确实要解除这个资料用户吗？\');">删除</a></td></tr>';
}
?>
          </tbody>
        </table>
