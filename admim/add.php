  ...
  <nav class="navbar navbar-fixed-top navbar-default">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="./">某宅密码查询系统后台</a>
      </div><!-- /.navbar-header -->
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active">
            ...
            <ul class="dropdown-menu">
              <li class="active"><a href="./add.php">添加资料</a><li>
			  <li><a href="./list.php">资料列表</a></li>
...
if($row!='')exit("<script language='javascript'>alert('后台已存在该资料用户！');history.go(-1);</script>");
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <form action="./add.php" method="post" class="form-horizontal" role="form">
			...
			<div class="input-group">
			<span class="input-group-addon">资料等级</span>
            ...
            <div class="input-group">
              <span class="input-group-addon">入库原因</span>
        ...
        <div class="panel-footer">
          <span class="glyphicon glyphicon-info-sign"></span> 加入资料!
        </div>
      </div>
    </div>
  </div>